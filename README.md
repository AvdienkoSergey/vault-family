...
│   │   └── mod.rs              #   SharedDB, X25519 key exchange, membership, entries
...
142 unit-теста покрывают все модули:
...
auth::tests                               (6 тестов)  — guard() JWT-only
...
- [x] Unit-тесты (142 теста: types, auth, failed_login_tracker, session_store, vault, crypto, shared, password_generator, handlers)
