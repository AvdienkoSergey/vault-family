...
```
 ...
 ✅ 12. auth/ и vault/ не зависят друг от друга (мост — VaultPass)
...
111 unit-тестов покрывают все модули:
...
- [x] Unit-тесты (111 тестов: types, auth, failed_login_tracker, session_store, vault, crypto, password_generator, handlers)
